# GCP postgresql offical coded copied
import datetime
import logging
import os
...
# Obtain environmental variables under PATH
...
db = sqlalchemy.create_engine(
    # The function below create a url that links to the desired database
...
@app.before_first_request # A decorator that serves as a Macro
def create_tables():
    # Create tables (if they don't already exist) by SQL
